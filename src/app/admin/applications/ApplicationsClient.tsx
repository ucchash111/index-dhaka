          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-[#111] text-[#fafaf8]">
                ...
                <th className="text-left px-4 py-3 text-[9px] font-bold tracking-[2px] uppercase hidden sm:table-cell">
                  Date
                </th>
                <th className="text-left px-4 py-3 text-[9px] font-bold tracking-[2px] uppercase">
                  Status
                ...
                <>
                  ...
                  >
                    ...
                    <td className="px-4 py-3 hidden md:table-cell">
                      <div className="text-xs text-[#555] max-w-[200px] truncate">
                        {app.building}
                      </div>
                    </td>
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`inline-block px-2 py-1 text-[9px] font-bold tracking-[1px] uppercase ${statusColors[app.status]}`}
                      >
                        {app.status}
                      </span>
                    </td>
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {app.status !== "rejected" && (
                          <button
                            ...
                            className="text-[10px] font-bold text-[#c0392b] hover:underline"
                          >
                            Reject
                          </button>
                        )}
                  ...
                  {expanded === app.id && (
                    <tr key={`${app.id}-expanded`} className="bg-[#fafaf8] border-b border-[#f0f0f0]">
                      <td colSpan={5} className="px-4 py-3">
                        <div className="text-[9px] font-bold tracking-[2px] uppercase text-[#888] mb-1">
                          What they&apos;re building
                        </div>
                        <p className="text-sm text-[#333]">{app.building}</p>
                        {app.link && (
                          <a
                            href={app.link}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-1 mt-2 text-xs text-[#c0392b] hover:underline"
                          >
