...
async function getMembers(): Promise<Member[]> {
  try {
    return await sql<Member[]>`SELECT * FROM members ORDER BY name ASC`;
  } catch {
    return [];
  }
}
    ...
    <div className="p-6 md:p-8">
      <div className="mb-6">
        ...
        <p className="text-sm text-[#888] mt-1">
          ...
          <span className="font-semibold text-[#111]">{featured.length} featured</span> of {members.length} total.
        </p>
      </div>
